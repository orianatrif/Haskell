...
printMatches matches = error "printMatches"
...
readContents _ = error "readContents"
...
maybeReadFile path = error "maybeReadFile"
...
parseContents _ = error "parseContents"
...
searchFiles _ _ = error "searchFiles"
